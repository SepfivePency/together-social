...
// Mock DM data
const DM_USERS = [
  { id: 'u2', name: 'Sarah Jenkins', avatar: 'https://picsum.photos/id/65/200/200', status: 'online', lastMsg: 'See you in class!' },
  { id: 'u3', name: 'Mike Ross', avatar: 'https://picsum.photos/id/91/200/200', status: 'offline', lastMsg: 'Thanks for the notes.' },
  { id: 'u4', name: 'Emily Chen', avatar: 'https://picsum.photos/id/120/200/200', status: 'online', lastMsg: 'Are we still on for lunch?' },
  { id: 'u5', name: 'David Kim', avatar: 'https://picsum.photos/id/150/200/200', status: 'idle', lastMsg: 'Check this link out' },
];

export const DirectMessages: React.FC<DirectMessagesProps> = ({ currentUser }) => {
  ...
  const activeChatUser = DM_USERS.find(u => u.id === selectedUser);
        ...
        <div className="flex-1 overflow-y-auto">
            {DM_USERS.map(user => (
                <button
                    ...
                    className={`w-full p-4 flex items-center gap-3 hover:bg-slate-800 transition-colors border-b border-slate-800/50
